...
//   padding: 10px;
//   border-radius: 5px;
//   background-color: ${(props) => (props.theme.darkMode ? "#333" : "#f1f1f1")};
//   width: 80%;
//   max-width: 400px;
//   text-align: center;
// `;
...
//   background: ${(props) => (props.theme.darkMode ? "#444" : "#ffffff")}; /* Slightly darker for contrast */
//   border: 1px solid ${(props) => (props.theme.darkMode ? "#666" : "#ccc")}; /* Subtle border */
//   color: ${(props) => (props.theme.darkMode ? "#ffffff" : "#333")}; /* Readable text */
//   cursor: pointer;
//   margin: 5px;
//   padding: 8px 14px;
//   font-size: 14px;
...
//   box-shadow: ${(props) => (props.theme.darkMode ? "2px 2px 8px rgba(255, 255, 255, 0.1)" : "2px 2px 8px rgba(0, 0, 0, 0.1)")}; /* Soft shadow for depth */

//   &:hover {
//     background: ${(props) => (props.theme.darkMode ? "#555" : "#f8f8f8")}; /* Light hover effect */
//     color: ${(props) => (props.theme.darkMode ? "#fff" : "#111")};
//     transform: scale(1.05);
//     box-shadow: ${(props) => (props.theme.darkMode ? "2px 2px 12px rgba(255, 255, 255, 0.2)" : "2px 2px 12px rgba(0, 0, 0, 0.2)")}; /* More depth on hover */
//   }
// `;
